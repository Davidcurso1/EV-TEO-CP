            ...
            <div className="col-span-1 lg:col-span-5 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-start">
                  ...
                  <div className="text-xs font-bold text-slate-900 uppercase">Duración</div>
                  <div className="text-sm text-slate-500">45 Minutos</div>
                </div>
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col items-start">
                  <div className="text-blue-600 mb-2">
                    <ShieldCheck className="w-5 h-5" />
                  </div>
                  <div className="text-xs font-bold text-slate-900 uppercase">Aprobación</div>
                  <div className="text-sm text-slate-500">Min. 80/100</div>
                </div>
              </div>
            </div>
